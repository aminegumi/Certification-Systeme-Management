...
if (isset($_POST['DeleteCourse'])){
    course::deletecourse('course',$connection->conn, $_GET['id']);
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Delete Course</h3>
                            </a>
                        </div>
                        ...
                        <div class="mb-3">
                            <p>
                                Click the button below if You want to delete the course titled : <?php echo $CourseName; ?><br/>
                                if students submited anything related To this Course will be Deleted.
                            </p>
                                     
                        
                        </div> 
                        <button type="submit" name ="DeleteCourse" class="btn btn-primary py-3 w-100 mb-4">Delete Course</button>
                        </form>
                    </div>
                </div>
            </div>
