...
if (isset($_POST['viewcertif'])){
    ...
    if(empty($groupe) ){
        ...
        $talamid = student::selectStudentByfiliereIdAndGroupe('student',$connection->conn,$fl['id_Filiere'],$groupe);
...
<header id="header" class="fixed-top">
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
        <div class="container">
            <h2>View Certificate for this Course : <?php echo $crs['nom_Course'] .' :   '. $matiere['nom_Matiere'] ; ?> course</h2>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="viewcertif" class="btn btn-success">View certif</button>
                </form>
            </div>
        </div>
    </div>
