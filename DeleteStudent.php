...
if (isset($_POST['DeleteStudent'])){
    student::deleteStudent('student',$connection->conn, $_GET['id']);
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Delete Student</h3>
                            </a>
                        </div>
                        ...
                        <div class="mb-3 ">
                            <p class="text-white">
                                Click the button below if You want to delete the Student : <b class="text-primary"><?php echo $firstName . ' ' . $lastName; ?></b>
                                Studying at <?php $data=filiere::selectfiliereById('filiere',$connection->conn,$FiliereIDValue);
                                echo '<b class="text-warning">'. $data['nom_Filiere'] .'</b> in Group '.'<b class="text-warning">'.  $groupeValue .'</b>'; ?><br/>
                                if you submited anything related To this Student will get Deleted.
                            </p>
                                     
                        
                        </div> 
                        <button type="submit" name ="DeleteStudent" class="btn btn-primary py-3 w-100 mb-4">Delete Student</button>
                        <button type="submit" name ="cancel" class="btn btn-dark py-3 w-100 mb-4">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
