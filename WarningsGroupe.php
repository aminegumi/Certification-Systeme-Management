...
if(isset($_GET["idmsgT"])){

 $idc=$_GET['idmsgT'];
 $crs=course::selectcourseById('course',$connection->conn,$_GET['idmsgT']);
...
$IDcourse = $_GET['idmsgT'];
$IDfiliere=$fl['id_Filiere'];
$groupe='';
$dateLimite = '';
if (isset($_POST['viewcertif'])){
    $groupe=$_POST['Groupe'];
    if(empty($groupe) ){
        $error = " Choose the Group !";
    }else{
        
        $talamid = student::selectStudentByfiliereIdAndGroupe('student',$connection->conn,$IDfiliere,$groupe);
        $_SESSION['talamid']=$talamid;
        $_SESSION['filierii']=$IDfiliere;
        $_SESSION['groupies']=$groupe;
        $_SESSION['coursawi']=$IDcourse;


        header('Location:ShowWarningsToTeach.php');
    }
}
...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
        <div class="container">
            <h2>View Warnings About this Course : <?php echo $crs['nom_Course'] .' :   '.$matiere['nom_Matiere'] ?> course</h2>
        </div>
            ...
            <div class="col-lg-6">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        $fl=filiere::selectfiliereById('Filiere',$connection->conn,$fl['id_Filiere']);
                    ...
                    <button type="submit" name="viewcertif" class="btn btn-success">View Warnigs</button>
                </form>
            </div>
        </div>
    </div>
