...
if (isset($_POST['DeleteTeacher'])){
    Teacher::DeleteTeacherById('teacher',$connection->conn, $_GET['id']);
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Delete Teacher</h3>
                            </a>
                        </div>
                        ...
                        <div class="mb-3">
                            <p>
                                Click the button below if You want to delete the Teacher : <?php echo $firstName . ' ' . $lastName; ?><br/>
                                if you submited anything related To this Teacher will get Deleted.
                            </p>
                                     
                        
                        </div> 
                        <button type="submit" name ="DeleteTeacher" class="btn btn-primary py-3 w-100 mb-4">Delete Teacher</button>
                        </form>
                    </div>
                </div>
            </div>
